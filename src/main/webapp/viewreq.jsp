      ...
      <ul class="nav navbar-nav">
         ...
         <li><a href="upload.jsp">Upload Files</a></li>                                              
          <li><a href="viewfile.jsp"> ViewFiles</a></li>
           ...
           <li><a href="status.jsp"> Request</a></li>
...
<br>
<table cellspacing="8" border="2" width="60%"  style="background-color: #a94442;">
			<tr>
				<th style="color: "><center>reqid</th>
				<th style="color: "><center>File Name</th>
				<th style="color: "><center>user email-Id</th>
				<th style="color: "><center>Status</th>
				<th style="color: "><center>Response</th>
				<%
			...
			try {
				...
				PreparedStatement pstmt = con.prepareStatement("select * from req,upload,userreg where req.uid=userreg.uid and req.oid='"+session.getAttribute("id9")+"' and upload.fid=req.fid and status='pending'");
			    ResultSet rs=pstmt.executeQuery();//select * from req,upload  where req.uid=? and upload.fid=req.fid
			    while(rs.next()){
			    	%>
	<tr>
				<td align="center"><font color="White"required><%=rs.getString(4)%></font></td>
				<td align="center"><font color="White"><%=rs.getString(7)%></font></td>
				 <td align="center"><font color="White"><%=rs.getString(17)%></font></td> 
				<td align="center"><font color="White"><%=rs.getString(5)%></font></td>

				
				<td align="center">
				<form action="accept.jsp">
				<input name="reqid" value="<%=rs.getString(4)%>" type="hidden">
