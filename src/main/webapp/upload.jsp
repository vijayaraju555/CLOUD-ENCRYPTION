        ...
        <div class="row">
          <div class="intro-text">
            ...
            <div align="center">
              ...
              <form name="f1" action="uploadback.jsp" method="POST" onsubmit="return validation()"
                style="background-color: #31708f;width: fit-content;border-radius: 10px;padding: 10px;">
                ...
                <div align="center">
                  ...
                  <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                  <input type="submit" value="upload" style="color: white; background-color: #608499">&nbsp;
                  <input type="reset" value="clear" style="color: white; background-color: #608499">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
              </form>
