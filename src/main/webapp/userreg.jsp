    ...
    <div class="overlay">
      <div class="container">
        <div class="row">
          ...
          <div align="center">
    <form action="userregback.jsp" style="background-color: darkgray;width: fit-content;border-radius: 10px;padding: 10px;">
		
			<h2 align="center" style="color: "> User Registration </h2>
			<table align="center">
