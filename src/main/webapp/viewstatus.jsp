...
<table cellspacing="8" border="2" width="60%" style="background-color: #a94442;"> 
			<tr>
				...
				<th style="color: "><center>Download</th>
				<%
				String s11=(String)session.getAttribute("id9").toString();
	...
	<tr>
			...
			<a href="encimg1.jsp?fid=<%=rs.getInt(1)%>"><font style="color: green"><b>Download</b></font></a>
				...
				<span style="color: white;font-weight: bold;">Download</span>
				<%} %>
